package TeleOp;
/**
 * @Filename:MecanumTeleOp.java
 * @Purpose:This file contains the TeleOp for Mecanum wheels
 * @Version:1.0
...
public class MecanumTeleOp extends OpMode {
    ...
    ArrayList<DcMotor> motorNames = new ArrayList<>();
    ...
    public void init() {
        ...
        motorNames.add(robot.frontLeft);
        motorNames.add(robot.frontRight);
        motorNames.add(robot.backLeft);
        motorNames.add(robot.backRight);
